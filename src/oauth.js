/**
 * Original author:
 * https://github.com/ddo/oauth-1.0a.git
 */

import {base64HmacSHA256Digest} from './crypto'
 ...
 */
OAuth.prototype.authorize = function(request, token = null) {
    var oauth_data = {
...
OAuth.consumer = function(key, secret) {
    const data = {
        consumer: {key, secret},
        signature_method: "HMAC-SHA256",
        hash_function: base64HmacSHA256Digest
    }
